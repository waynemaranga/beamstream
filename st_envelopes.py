...
class ShearForceEnvelope:
    ...
    def plotly(self) -> Figure:
        ...
        fig.add_hline(y=0)
        # fig.update_yaxes(major=dict(ticklen=3, tickcolor="grey", tickmode='auto', nticks=3, showgrid=True))
        # fig.update_xaxes(minor=dict(ticklen=3, tickcolor="grey", tickmode='auto', nticks=3, showgrid=True))
